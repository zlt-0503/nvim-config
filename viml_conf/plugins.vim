...
if g:is_win || g:is_mac
  ...
  " Avoid an `o` prefix because it delays the built-in open-line command.
...
if executable('latex')
  ...
  augroup vimtex_common
    ...
    autocmd FileType tex nnoremap <buffer> <F9> <cmd>lua NvimConfig.make_or_keys("<Plug>(vimtex-compile)")<CR>
  augroup END
...
""""""""""""""""""""""""""""""nvim-gdb settings""""""""""""""""""""""""""""""
nnoremap <leader>dg :<C-U>GdbStart gdb -q %<CR>
